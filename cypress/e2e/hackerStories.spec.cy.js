    ...
    context('Footer and list of stories', () => {
      ...
      context('List of stories', () => {
        ...
        it('shows the right data for all rendered stories', () => {
          ...
          .should('be.visible')
          .should('contain', stories.hits[0].title)//verificando se o titulo do elemento é igual ao do primeiro elemento do hits
      ...
      //   cy.intercept({//aguardar uma requisição acabar antes de seguir adiante/ utilizando agora o intercept com objeto
      //     method: 'GET',
      //     pathname: '**/search',
      //     query: {
      //       query: initialTerm,
      ...
      //   cy.visit('/')// o barro quer dizer que visitaremos a link que está definido no baseUrl
      ...
      .should('be.equal', newTerm)
        ...
        //   //só apresentando uma alternativa diferente
        // it.only('types and submits the form directly', () => {
        //   cy.get('#search')
        //     .type(newTerm)
        //   cy.get('form').submit()// envia forms(não é uma forma que o usuario faria, pq o usuario necessitaria clicar no botão do form)
        ...
        context('Last searches', () => {
          it('shows a max of 5 buttons for the last searched terms', () => {
            ...
            //o codigo abaixo tem a mesma função do comentario acima, porem a abodagem do within pode ser boa para seletores grandes
